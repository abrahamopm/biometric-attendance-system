...
const Sidebar: React.FC = () => {
    ...
    return (
        <nav className="w-64 bg-surface border-r border-gray-200 p-6 hidden md:block overflow-y-auto flex-shrink-0 flex flex-col">
            {/* Logo */}
            <div className="mb-10">
            ...
            <div className="space-y-2 flex-1">
                <div className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3 px-3">
                    Navigation
                </div>
                {menuItems.map((item) => {
                        ...
                        <Link
                            ...
                            className={`
                                ...
                                ${isActive
                                    ...
                                    : 'text-gray-600 hover:bg-gray-100 hover:text-primary border border-transparent'
                                }
                            `}
                        >
            ...
            <div className="mt-auto pt-6 border-t border-gray-800">
                <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-red-500/10 hover:text-red-500 transition-all border border-transparent hover:border-red-500/30"
                >
