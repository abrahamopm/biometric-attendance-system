...
import { Camera, CheckCircle, AlertCircle, RefreshCw, Trash2 } from 'lucide-react';
...
const FaceEnroll = () => {
    ...
    const handleDelete = async () => {
        if (!window.confirm('Are you sure you want to permanently delete your face data? This action cannot be undone.')) {
            return;
        }
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 min-h-full">
            ...
            <div className="bg-surface/50 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex flex-col items-center gap-8">
                    <div className="relative rounded-full overflow-hidden w-64 h-64 border-4 border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                        {capturedImage ? (
                            ...
                            <div className="flex flex-col items-center justify-center w-full h-full bg-gray-800 text-gray-400 p-4 text-center">
                ...
                {/* Delete Face Data Button - Positioned at bottom right of the container */}
                <button
