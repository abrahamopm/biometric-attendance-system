        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-400 mt-1">Create and manage your attendance sessions</p>
                </div>
                <button
            ...
            <div className="bg-surface/30 backdrop-blur-md border border-white/5 rounded-2xl p-6">
                <h2 className="text-xl font-bold mb-6">Your Events ({filteredEvents.length})</h2>
                    ...
                    <div className="space-y-4">
                        {filteredEvents.map((event, index) => (
                            <motion.div
                                ...
                                className="flex flex-col md:flex-row md:items-center justify-between p-5 bg-black/20 rounded-xl border border-white/5 hover:border-primary/30 transition-all group gap-4"
                            >
