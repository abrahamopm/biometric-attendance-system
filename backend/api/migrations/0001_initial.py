# Generated by Django 6.0.1 on 2026-01-07 14:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('host', 'Host'), ('admin', 'Admin')], default='student', max_length=10)),
                ('phone', models.CharField(blank=True, max_length=20)),
                ('face_embedding', models.BinaryField(blank=True, help_text='Numpy array bytes', null=True)),
