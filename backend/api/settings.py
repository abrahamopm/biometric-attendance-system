...
# In a real scenario, use PostgreSQL as requested:
# DATABASES = {
#     'default': {
...
CORS_ALLOW_ALL_ORIGINS = True # For development with Streamlit

# Biometric Data Encryption Settings
ENCRYPTION_KEY = env('ENCRYPTION_KEY').encode()

# SMTP Email Settings (Placeholder)
